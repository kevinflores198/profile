const translations = {
  es: {
    ...
    // project 2
    "project2-title": "Comercio Electrónico",
    "project2-exp": "Tienda en línea con carrito de compras, sistema de pagos y panel de administración.",
    "project2-btn": "Ver proyecto",

    // project 3
    "project3-title": "Plataforma de Blog",
    "project3-exp": "Sistema de blogs con cuentas de usuario y gestión de contenido.",
  ...
  pt: {
    ...
    // project 2
    "project2-title": "Comércio Eletrônico",
    "project2-exp": "Loja online com carrinho de compras, sistema de pagamento e painel administrativo.",
    "project2-btn": "Ver projeto",
    // project 3
    "project3-title": "Plataforma de Blog",
    "project3-exp": "Sistema de blog com contas de usuário e gerenciamento de conteúdo.",
